...
export function* authSaga() {
	all([
		...
		yield takeEvery(GENERATE_LIST_OF_PERMISSIONS, generateAndSetListOfPermissionsWorker),
		...
		yield takeLeading(SET_IS_SUBSCRIPTION_PAID_SUCCESS, onSubscriptionPaidSuccessWorker),
		yield takeLeading(SET_IS_SUBSCRIPTION_PAID_FAIL, onSubscriptionPaidFailWorker),
	]);
}
