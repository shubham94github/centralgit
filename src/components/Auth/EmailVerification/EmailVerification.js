...
const EmailVerification = ({
  ...
  useEffect(() => {
    ...
    } else if (emailVerificationError) clearInterval(intervalId.current);
  ...
  return (
    <section className="sign-up-verification-section ">
      <div className="sign-up-verification-container auth-background-dark">
        ...
        {isEmailVerified ? (
          <>
            ...
            <P14 className="description">
              ...
              <span
                className="blue-link link underline"
          ...
          <>
            <P16 className="label" bold>
              Email verifying in progress. Please wait.
            </P16>
...
export default connect(
  ({ auth }) => {
    const { isLoading, user, isEmailVerified, emailVerificationError } = auth;
