...
function Auth() {
  ...
  return (
    <Switch>
      ...
      <Route path={Routes.AUTH.SIGN_UP.INDEX} component={SignUp} />
      <Route
      ...
      />
      <Route path={Routes.AUTH.SIGN_UP.INDEX} component={SignUp} exact />
      <Route path={Routes.AUTH.TWO_FA} component={TwoFa} />
      <Route
