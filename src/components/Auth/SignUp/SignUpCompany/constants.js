...
const createStartup = "Create Startup";
const SubmitStartup = "Submit Startup";
const privacyPolicyText =
  "I agree to the Retailhub’s Terms of Service, " +
  "Privacy Policy and Security Policy, including Cookie Use Policy.";
const couponNotExistTextError =
  "The code you entered does not exist or has expired.";
const startupLabel = "Startup";
export {
  isCompanyOptions,
