    ...
    <>
      ...
      <FormWrapper className="signup-email-wrapper">
        <Container className="email-form-container">
          <P16>
            {titlePart1}
            <span className="title-main"> {titlePart2}</span>
            {titlePart3}
          </P16>

          <GridContainer customClassName="field-container--input">
            <div>
              <TextInput
                id="email"
                type="email"
          ...
          <GridContainer customClassName="field-container--button">
            <div>
              <PrimaryButton
          ...
          <div className="field-container--switch">
            <P12>
              <span>Already have an account?</span>
              <NavLink
                className="primary-link bold underline"
