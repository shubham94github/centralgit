...
export const startupDescription1 = 'If you would like your company to be added to our curated list of innovative '
	+ 'startups and be in contact with thousands of established brands and big companies.';
export const startupDescription2 = 'RetailHub Innovation Explorer will give exposure to your Startup, expect '
	+ 'guaranteed results through the use of our intelligent matching system, giving you better access to potential '
	+ 'clients and partners.';
export const companyDescription = 'RetailHub Innovation Explorer uses an intelligent matching system tailored'
...
export const submitBtnText = 'Continue';
