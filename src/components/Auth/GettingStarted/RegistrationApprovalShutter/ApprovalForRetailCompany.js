		...
		<div className='registration-approval-container' style={cssStyle}>
			<div className='registration-approval-content'>
				...
				<P14>
					{!!trial
						? <>
							You have a FREE {trial} day trial period that will start once your account is approved.
							You will only be charged the amount according to your Subscription plan after the
							FREE trial period has ended.
						</>
						: <>
							There is no trial period in your payment plan. You will be charged the amount right now.
						</>
					}
					<br/>
					<br/>
					Please wait a few seconds and you will be redirected to the home page where
					RetailHub has matched Startups that are most related to your interest.
				</P14>
