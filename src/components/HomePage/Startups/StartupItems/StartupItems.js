...
const StartupItems = ({
  ...
  const onClickStartupHandler = useCallback(
    (id) => history.push(`/profile/startup/${id}`),
    [history]
  );
  ...
  const onRedirectHandler = () => {
    if (!isTrial || trialData?.isTrialSearch) successfulHandleSearch();
          ...
          return (
            ...
            >
              <div className="item-container">
                <div className="d-flex justify-content-center img-wrapper-home">
                  <Avatar logo={startup.logo120} />
                </div>
                <div>
                  <div className="d-flex justify-content-start">
                    <span className="company-short-name truncate-short-name clickable">
