		...
		<section className='subscription-section'>
			<Switch>
				<Route
					...
					exact
				/>
				<ProtectedRoute path={RETRY_OR_UPDATE} component={RetryOrUpdateSubscription}/>
				<ProtectedRoute path={UPDATE_CARD} component={AddRetailCompany}/>
				<ProtectedRoute path={CHANGE_PLAN} component={ChooseYourPlan}/>
				<ProtectedRoute path={UPDATE_CARD_SUCCESSFULLY} component={UpdateCardSuccessfully}/>
				<ProtectedRoute path={UPDATE_CARD_FAILED} component={UpdateCardFailed}/>
