...
const ProfileSection = ({
	...
	useEffect(() => {
		if (isStartup)
			getProfileStartupForAdmin({ id: idProfile });
	...
	return (!isVisibleProfile
		...
		: <div className='profile-wrapper'>
			...
			<Switch>
				...
				/>
				<ProtectedRoute
					path={PROFILE.BILLING_DETAILS}
					component={BillingDetails}
					exact
				/>
				<ProtectedRoute
					path={PROFILE.BOOKMARKS_STARTUP}
					component={ListOfStartupBookmarksHOC}
					exact
				/>
				<ProtectedRoute
					path={PROFILE.RATED_STARTUPS}
					component={ListOfRatedStartupsHOC}
					exact
				/>
				<ProtectedRoute
					path={PROFILE.COMPANY_MEMBERS}
