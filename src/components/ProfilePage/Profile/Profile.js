				...
				<div className='right-side-profile'>
					{
						isRetailer && !isEmpty(companySectors)
							? <>
								<H1
									className='text-black text-start pt-4'
									bold
								>
					...
					{companyDescription
						&& <div className='list-style-descriptions'>
							<H1 className='text-black text-start pb-3 mt-40' bold>Company Description</H1>
					...
					{!isRetailer && solutionProductsServices && (
						<div className='list-style-descriptions'>
							<H1
								className='text-black text-start pb-3 mt-40'
								bold
							>
					...
					{!isRetailer && !isEmpty(areasOfInterest)
						&& <>
							<H1
								className='text-black text-start mt-40'
								bold
							>
								Areas of interest
							</H1>
...
export default connect(({ auth: { user }, common: { trialData } }) => ({
