...
const ProfileHeader = ({
	...
	const aboutItems = useMemo(() => setAboutItems(country, owner, foundedAt, totalFundingAmount),
		[country, owner, foundedAt, totalFundingAmount]);

	const isVisibleChatIcon = (isFullNameFilled && !isStartup) && (
		isRetailer
			? !isAuthRoleRetailer
			:!isDemoStartup && isEnableMailing
	);
			...
			<div className='image-section'>
				...
				<div>
					<div className='company-name'>
						...
						>
							<H1 className='text__black text-start'>
								{companyShortName}
							</H1>
						</Tooltip>
						{isVisibleChatIcon
										...
										<div className='d-flex' key={id}>
											<div className='about-item'>
												...
												<Tooltip
													...
													message={owner}
												>
													<S16 className='value' bold>{value.text}</S16>
												</Tooltip>
											</div>
											{
