...
export const updateCompanyDetailsDemo = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-info/demo`, data);

export const updateCompanyDetailsStartup = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-info/standard`, data);

export const updateCompanyDetailsIncomplete = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-info/incomplete`, data);

export const updateCompanyDetailsRetailer = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/retailer/edit/${id}/update-company-details`, data);

export const updateSectorOfCompetence = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-sectors`, data);

export const updateAreasOfInterest = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-areas`, data);

export const updateTags = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-tags`, data);

export const updateAccountInformation = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-user-info`, data);

export const updateAccountInformationRetailer = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/retailer/edit/${id}/update-account-information`, data);

export const saveStartupInternalGallery = ({
	title,
	link,
	description,
	source,
...
export const updateStartupFiles = ({ documentId, id }) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/startup-gallery/edit/${id}/files/update`, { documentId });

export const removeStartupVideo = ({
	title,
	link,
	description,
	source,
...
export const createStartupGallery = ({
	title,
	link,
	description,
	source,
...
export const updateStartupGallery = ({
	title,
	link,
	description,
	source,
...
export const updateStartupVideo = galleryData => {
	return galleryData.videoId
		...
		: galleryData.link ? createStartupGallery(galleryData) : new Promise(resolve => resolve());
};
...
export const updateStartupLogo = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-logo`, data);

export const updateRetailerLogo = data => client.post(`${ADMIN_SERVER_URL}/v1/admin/retailer/edit/update-retailer-logo`, data);

export const updateUserAvatar = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/${id}/update-startup-user-avatar`, data);

export const updateUserRetailerAvatar = data => client.post(`${ADMIN_SERVER_URL}/v1/admin/retailer/edit/update-user-logo`, data);

export const updateFeedback = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/feedback/${id}/update`, data);

export const removeFeedback = id => client.delete(`${ADMIN_SERVER_URL}/v1/admin/startup/feedback/${id}/delete`);

export const updateAdminNote = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/note/${id}/update-admin-note`, data);

export const updateBillingAddress = (data, id) => client.post(`${ADMIN_SERVER_URL}/v1/admin/retailer/billing-details/${id}/update`, data);
...
export const updateCategory = data => client.post(`${ADMIN_SERVER_URL}/v1/admin/categories/edit/update/${data.id}`, data);

export const deleteCategory = categoryId => client.delete(`${ADMIN_SERVER_URL}/v1/admin/categories/delete/${categoryId}`);
...
export const verifyRetailer = retailerIds => client.post(`${ADMIN_SERVER_URL}/v1/admin/retailer/edit/verify-retailer-email`, { retailerIds });

export const verifyStartup = startupIds => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/edit/verify-startup-email`, { startupIds });

export const getAllReports = filterInDto => client.post(`${ADMIN_SERVER_URL}/v1/admin/startup/analysis/report/find-all-reports`, filterInDto);

export const getCountOfAllReports = () => client.get(`${ADMIN_SERVER_URL}/v1/admin/startup/analysis/report/count-reports`);

export const cancelReportById = id => client.delete(`${ADMIN_SERVER_URL}/v1/admin/startup/report/cancel-report-by-id/${id}`);

export const getAllAuthority = () => client.get(`${ADMIN_SERVER_URL}/v1/admin/authority/all`);

export const getAuthorityWithPermissionsForProfile = () => client.get(`${ADMIN_SERVER_URL}/v1/admin/activity/all-activities`);
...
export const createAuthority = ({ name, permissions }) => client.post(`${ADMIN_SERVER_URL}/v1/admin/authority/create`, {
	name,
	permissions,
});
...
export const updateAuthority = ({ id, name, permissions }) => client.post(`${ADMIN_SERVER_URL}/v1/admin/authority/update/${id}`, {
	name,
	permissions,
});

export const checkIsPublicRetailer = id => client.post(`${ADMIN_SERVER_URL}/v1/admin/retailer/view/check-retailer-type/${id}`);
...
export const downloadReportFile = id => {
	...
	return axios.get(`${FILE_UPLOADER_URI}/v1/document/download/${id}`, {
		responseType: 'blob',
		headers: {
...
export const fetchDiscountCoupons = code => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/discount/codes/all`, {
	code,
});

export const removeDiscountCoupons = codeIds => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/discount/codes/delete`, {
	codeIds,
});

export const cancelDiscountCoupons = codeIds => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/discount/codes/cancel`, {
	codeIds,
});

export const blockDiscountCoupons = codeIds => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/discount/codes/block`, {
	codeIds,
});

export const unblockDiscountCoupons = codeIds => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/discount/codes/unblock`, {
	codeIds,
});
...
export const activateAdminUser = ids => client.post(`${ADMIN_SERVER_URL}/v1/admin/admins/status/unblock`, {
	ids,
});

export const deActivateAdminUser = ids => client.post(`${ADMIN_SERVER_URL}/v1/admin/admins/status/block`, {
	ids,
});
...
export const createNewFeature = featureData => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/catalog/features/create`, featureData);

export const editFeature = items => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/catalog/features/update`, { items });

export const deleteFeature = featureId => client.delete(`${ADMIN_SERVER_URL}/v1/admin/payment/catalog/features/delete/${featureId}`);

export const getMemberGroups = () => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/catalog/member-group/all`);

export const createNewMemberGroup = memberGroupData => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/catalog/member-group/create`, memberGroupData);

export const editMemberGroup = ({ memberGroupData, groupId }) => client.post(`${ADMIN_SERVER_URL}/v1/admin/payment/catalog/member-group/update/${groupId}`, memberGroupData);

export const deleteMemberGroup = groupId => client.delete(`${ADMIN_SERVER_URL}/v1/admin/payment/catalog/member-group/delete/${groupId}`);
